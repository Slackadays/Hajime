...
void Text::applyLang(string lang) {
              ...
              if (lang == "es") { //spanish
                ...
                help.push_back(" [las siguientes señalas]");
                ...
                help.push_back("\033[1m-s  \033[0mo\033[1m --install-server \033[1m|\033[0m Crear un archivo estándar para la configuración de un servidor.");
                help.push_back("\033[1m-ih \033[1m\033[3marchivo \033[0mo\033[1m --install-hajime-config \033[1m\033[3marchivo \033[0m\033[1m|\033[0m Instalar el archivo estándar que usa Hajime.");
              }
}
