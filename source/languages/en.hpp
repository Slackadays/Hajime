...
help.push_back("-p or --privileged | Bypass the privileged user check.");
...
error.ConfDoesNotExist = "Config file {} doesn't exist!";
...
error.ServerFileNotPresent = "The server's config file ({}) doesn't exist";
error.CouldntSetPath = "Couldn't set the path.";
error.Generic = "Whoops! An error occurred: {}";
...
error.PrivilegedUser = "You cannot run Hajime as a privileged user; to disable this, add --privileged as an argument";
...
question.UseDefaultServerFile = "Would you like to use the default server file ({}) or something else?";
...
option.CurrentLanguage = "The current language ({})";
...
info.CreatedServerConfig = "The config file ({}) has been created";
...
info.TryingFilesystem = "Trying {} filesystem";
...
info.wizard.NextStepServerFile = "Next Steps: Enter your server settings in {}.";
...
info.HajConfigMade = "Hajime config file ({}) made!";
...
info.EnterNewNameForServer = "Enter a new name for the next server file (the previous one was {}): ";
info.MakingHajimeDirectory = "Creating Hajime directory at ";
debug.HajDefConfNoExist = "Tried to read settings from {} but it doesn't exist";
...
debug.counters.perfstructTooSmall = "Event perfstruct is too small";
debug.counters.groupfdNotValid = "Event group_fd not valid";
debug.counters.exclusiveAccess = "Another process has exclusive access to performance counters";
debug.counters.invalidMemoryAddress = "Invalid memory address";
debug.counters.invalidEvent = "Invalid event";
debug.counters.eventNotSupported = "Event not supported on this CPU";
debug.counters.invalidEventType = "Invalid event type";
debug.counters.tooManyHardwareBreakpoints = "Too many hardware breakpoint events";
debug.counters.hardwareSupport = "Hardware support not available";
debug.counters.unsupportedEventExclusion = "Unsupported event exclusion setting";
debug.counters.invalidPID = "Invalid PID for event; PID = ";
debug.counters.otherError = "Other performance counter error; errno = ";
...
server.restart.alert = " \"§6[Hajime]§f Alert: This server is automatically restarting in {} minutes\"";
...
server.command.uptime.output = "[Hajime] This server's uptime is {} minutes ({} hours)";
server.command.restart.regex = ".r(estart)";
server.command.restart.output = "[Hajime] This server is restarting in {} minutes ({} hours)";
...
server.command.system.key.temps = "temps";
server.command.system.key.storage = "storage";
