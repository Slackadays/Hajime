...
info.WizardHajimeFile = "Empezamos hacer el archivo que usará Hajime para las configuraciones básicas.";
info.WizardServersFile = "Entonces, necesitamos instalar el \"archivo de servidores,\" donde Hajime buscará los servidores.";
info.WizardServerFile = "Necesitamos un archivo de servidor para las configuraciones de un servidor.";
info.WizardStartupService = "Finalmente, necesitamos ejecutar Hajime cuando enciende el SO.";
info.WizardComplete = "¡Está completada la configuración!";
info.WizardNextStepServerFile1 = "El Próximo Paso: Poner las configuraciones del servidor en ";
...
debug.FlagVecInFor = "flagVector[0] en el bucle For =";
debug.FlagVecOutFor = "flagVector[0] afuera el bucle For =";
