...
help.push_back("-ss u --install-servers-file | Instalar un archivo para apuntar los servidores.");
...
server.restart.minutes5 = "[Hajime] Este servidor reiniciará en §b5 §fminutos";
server.restart.minutes15 = "[Hajime] Este servidor reiniciará en §b15 §fminutos";
...
server.command.help.output1 = "[Hajime] Posa el cursor sobre un comando para ver la acción.";
...
server.command.die.output = "[Hajime] Tiró un dado y consiguió §b";
...
server.command.uptime.output1 = "[Hajime] El tiempo de funcionamiento de este servidor es §b";
