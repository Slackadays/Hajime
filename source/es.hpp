...
server.command.uptime.output1 = "[Hajime] El tiempo de funcionamiento de este servidor es ";
server.command.uptime.output2 = " minutos (";
server.command.uptime.output3 = " horas)";
