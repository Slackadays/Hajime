...
server.command.help.message.perf = "Show this server's performance statistics.";
...
server.command.restart.regex = ".restart";
...
server.command.system.regex = ".system";
server.command.perf.regex = ".perf";
