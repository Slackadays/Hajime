...
info.WizardHajimeFile = "Let's start with creating the file that Hajime will use for its basic settings.";
info.WizardServersFile = "Next, we'll need to install the \"servers file,\" or where Hajime looks for servers to start up.";
info.WizardServerFile = "Now we need a server file to define one of your servers to run.";
info.WizardStartupService = "Finally, we need to make Hajime start upon the host booting.";
info.WizardComplete = "Setup complete!";
info.WizardNextStepServerFile1 = "Next Steps: Enter your server settings in ";
...
debug.FlagVecInFor = "flagVector[0] in For loop =";
debug.FlagVecOutFor = "flagVector[0] outside of For loop =";
