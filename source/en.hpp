...
questionUseFlags = "Would you like to apply any pre-made java arguments to your server?";
...
questionEnterCustomFlags = "Enter your custom flags here: ";
...
optionLetHajimeDeduce = "Let Hajime deduce it for me [Unimplemented]";
...
optionAikarFlags = "Use Aikar's flags";
optionHillttyFlags = "Use Hilltty's flags";
optionFroggeMCFlags = "Use FroggeMC's ZGC Flags";
optionBasicZGCFlags = "Use basic ZGC flags";
optionCustomFlags = "Use custom flags";
