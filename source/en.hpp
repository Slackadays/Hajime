...
server.restart.minutes5 = "[Hajime] This server is restarting in §b5 §fminutes";
server.restart.minutes15 = "[Hajime] This server is restarting in §b15 §fminutes";
...
server.command.help.output1 = "[Hajime] Roll over a command to show its action.";
...
server.command.die.output = "[Hajime] Rolled a die and got §b";
...
server.command.uptime.output1 = "[Hajime] This server's uptime is §b";
