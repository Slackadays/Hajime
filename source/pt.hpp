...
error.ConfDoesNotExist1 = "Arquivo de configuração ";
error.ConfDoesNotExist2 = " não existe!";
...
error.ServersFilePresent = "Arquivo de servidores já existe!";
error.ServerFileNotPresent1 = "O arquivo de configuração do servidor (";
error.ServerFileNotPresent2 = ") não existe.";
error.ServersFileNotCreated = "Arquivo de servidores não foi criado.";
...
error.NoServersFile = "Nenhum arquivo de servidor encontrado";
...
question.WizardServersFile = "Você deseja instalá-lo agora?";
...
question.UseDefaultServerFile1 = "Você gostaria de usar o arquivo padrão do servidor (";
question.UseDefaultServerFile2 = ") ou alguma outra coisa?";
...
info.CreatedServerConfig1 = "O arquivo de configuração (";
info.CreatedServerConfig2 = ") foi criado";
...
info.TryingFilesystem1 = "Tentando o sistema de arquivos ";
...
info.WizardHajimeFile = "Vamos começar com a criação do arquivo que o Hajime utilizará para suas configurações básicas.";
info.WizardServersFile = "Agora, precisaremos estabelecer o \"arquivo de servidores\", ou onde o Hajime procura por servidores para iniciar.";
info.WizardServerFile = "Agora precisamos de um arquivo de servidor para definir um de seus servidores a ser executado.";
info.WizardStartupService = "Por último, precisamos fazer com que o Hajime inicie na inicialização do host.";
info.WizardComplete = "Instalação completa!";
info.WizardNextStepServerFile1 = "Próximos Passos: Digite as configurações de seu servidor em ";
info.WizardNextStepServerFile2 = ".";
...
info.HajConfigMade1 = "Arquivo de configuração do Hajime (";
info.HajConfigMade2 = ") feito!";
...
info.InstallingServersFile = "Instalando o arquivo padrão de servidores em ";
info.CheckingExistingServersFile = "Procurando por um arquivo existente...";
info.MadeServersFile = "Arquivo de servidores feito!";
...
debug.FlagVecInFor = "flagVector[0] no loop For =";
debug.FlagVecOutFor = "flagVector[0] fora do loop For  =";
debug.UsingOldMethod = "Utilizando o método antigo";
debug.UsingNewMethod = "Utilizando o novo método";
debug.Flags = "Flags =";
debug.FlagArray0 = "flagArray[0] =";
debug.FlagArray1 = "flagArray[1] =";
