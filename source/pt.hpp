...
info.wizard.ServersFile = "Agora, precisaremos estabelecer o \"arquivo de servidores\", ou onde o Hajime procura por servidores para iniciar.";
...
info.wizard.NextStepServerFile1 = "Próximos Passos: Digite as configurações de seu servidor em ";
